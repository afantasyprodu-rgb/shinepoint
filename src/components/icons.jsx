// Inline SVG icons (Lucide outlines, 24x24 viewBox).
// Size with className (default w-6 h-6); color follows currentColor.

function Icon({ children, className = 'h-6 w-6', label }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function TagIcon(props) {
  return (
    <Icon {...props}>
      <path d="M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.792-6.792a2.426 2.426 0 0 0 0-3.42z" />
...
// Favorites (077). `filled` swaps the outline for a solid heart — the path's
// own fill attribute wins over the `fill="none"` the Icon wrapper sets on
// the <svg>, so no separate icon is needed for the two states.
