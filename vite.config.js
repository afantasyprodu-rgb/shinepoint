...
const CSP = [
  ...
  "img-src 'self' data: blob: https://tiles.stadiamaps.com https://*.tile.openstreetmap.org https://*.basemaps.cartocdn.com https://images.unsplash.com https://*.supabase.co",
